  ...
  <div class="py-10 container mx-auto">
    ...
    >
      ...
      <li>
        ...
        <p>
          No. I update the list whenever practically possible. Anyone can submit
          a PR to update the list
      ...
      <li>
        <label
          >I'm a developer, how can I get the list of affected countries?</label
        >
        <p>
