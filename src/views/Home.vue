<template>
	<div class="home">
      ...
      "
		>
			...
			>
				<div class>
					...
					<p class="text-white py-2 text-center uppercase text-sm">Type a country name to check status</p>
				</div>
            ...
            "
              ...
              `https://www.google.com/search?q=covid%2019%20in%20${selectedCountry}`
            "
					>Latest news on COVID-19 in {{ selectedCountry }}</a>
				</div>
			</div>
		...
		<div class="w-full last-updated text-center uppercase py-2 font-bold bg-gray-100 text-gray-500">
...
export default {
	...
	data() {
		return {
			...
			lastUpdated: "20th March 2020 @ 13:15 GMT"
		};
	},
	mounted() {
